...
const page = () => {
  return (
    ...
    >
      <Image width={320} height={320} alt={personalInfo.name} className='rounded-full block mx-auto  shadow-black shadow-sm border-[1px] dark:border-none' src={personalInfo.imageUrl} />
      <h2
