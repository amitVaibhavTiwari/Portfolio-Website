...
const Experience = () => {
    ...
    return (
        <section className='mx-auto'>
            <h2 className="text-black dark:text-white text-[1.7rem] md:text-[2.5rem] font-bold text-center mb-6 md:mb-8">What I've Been Doing</h2>
                ...
                {experiences.map((exp) => (
                    <div key={exp.id} className="flex gap-2 lg:gap-20 flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/4 lg:pr-8 mb-1 md:mb-0">
                            <p className="text-md italic font-light lg:text-gray-700 lg:dark:text-white">{exp.duration}</p>
                        </div>
