    ...
    <PageChanger>
      <div className="about-pg">
        ...
        <p className="info-para">
          ...
          js, Node js, Express js, PostgreSQL, MongoDB and so on. I'm also good
          at solving problems using Java.
          <br />I am a quick learner and continuously seek to expand my
          knowledge in the field. I am currently learning React Native to create
          native mobile applications, which will further enhance my skills. I am
          not only a talented designer and developer, but also a natural leader
          who is a hard worker and a great team player. I thrive under pressure
